...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Books
      \begin{itemize}
      \item \href{https://www.amazon.co.jp/dp/4798139785/}{\scriptsize{OpenStack クラウドインテグレーション}}
      \item \href{https://www.amazon.co.jp/dp/4798155128/}{\scriptsize{インフラ CI 実践ガイド}} (as a reviewer)
      \end{itemize}
    \item[] \includegraphics[height=15mm]{images/OpenStack_Integration_book.png}~\includegraphics[height=15mm]{images/InfraCI_book.png}
    \item Hobby: Bike(BMC SLR02), (Home)Clouds(OpenStack...), Diet(Low-carb), etc.
