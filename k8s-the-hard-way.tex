  ...
  \begin{itemize}
    ...
    \item Job: Senior Software Engineer/Open Source Programmer
      \begin{itemize}
        ...
        \end{scriptsize}
      \end{itemize}
    \item Books \includegraphics[scale=0.1]{images/OpenStack_Integration_book.png}~\includegraphics[scale=0.1]{images/InfraCI_book.png}
      \begin{itemize}
...
\begin{frame}
  \frametitle{Do you want to... - cont.}
  \begin{itemize}
...
\begin{frame}
  \frametitle{If it meets you, there's}
  \begin{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    \item Hours: 2.5H, Cost: less than \$1 on GCP
    ...
    \item We can read, write and participate its code and community because it's open source!
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{[WIP] One more thing - Running in an OpenStack Cloud}
  \begin{itemize}
    \item ======= TODO ============
    \item Built a new OpenStack Cloud
    \item Architecture(OpenStack Rocky, Nova/Glance/Cinder/Keystone/Neutron with my own ansible playbook)
    \item Cost
    \item Problem
    \item Challenges
    \item Pictures(Old and new ones)
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{One more thing - Running in an OpenStack Cloud}
...
\begin{frame}
  \frametitle{Conclusion - challenges, tricks, misc.}
  \begin{itemize}
    \item It's better to run and customize it on your own environment, and try/error to understand
    ...
    \item This is only for learning not for production (i.e. HA, Persistent Volume, etc.)
    ...
    \begin{itemize}
      ...
      \href{https://www.oreilly.co.jp/books/9784873118406/}{(Japanese version: 入門 Kubernetes)}
      \item
      \href{https://book.impress.co.jp/books/1118101055}{Kubernetes完全ガイド (Kubernetes Perfect Guide)}
      \item
      \href{https://www.shoeisha.co.jp/book/detail/9784798155371}{コンテナ・ベース・オーケストレーション (Container based orchestration)}
      \item[]
      \item[] \includegraphics[height=20mm]{images/kubernetes_up_and_running.jpeg}
