...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item 6インスタンス(n1-standard-1)使用(Controller * 3 + Worker * 3)
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  Appendix
  \begin{itemize}
      \item Slides: \url{https://bit.ly/k8s-the-hard-way-jkd-v1812}{https://bit.ly/k8s-the-hard-way-jkd-v1812}
