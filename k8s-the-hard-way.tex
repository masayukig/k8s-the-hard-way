...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item You can read, write and participate its code and community because it's open source!
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{One more thing - Running in an OpenStack Cloud}
  It can be run in an OpenStack cloud, too! But some modifications are necessary.
  \begin{itemize}
    \item Boot instances
